...
<body>
    <div style="background-color: black"> 
        <table id="foot_table" >
            ...
            <tr>
                <td class="foot_td"> <a class="foot_a_class">    사업자 : com8e(주)      </a>     </td>
                <td class="foot_td"> <a class="foot_a_class">    대표 : 최명환           </a>    </td>
                <td class="foot_td" colspan="3"> <a class="foot_a_class">    사업자 등록 번호 : 123-12-12345       </a>    </td>
                <td class="foot_td"> <a class="foot_a_class">    주소 : 대전 서구 둔산로12       </a>    </td>
            </tr>
