...
>>>>>>> refs/heads/master
	...
	public String ProdRegist(@ModelAttribute("prod") ProdVO prod, ModelMap model) throws Exception {
		String view = "common/message";

		prodService.insertProd(prod);

		ResultMessageVO messageVO = new ResultMessageVO();
		messageVO.setResult(true).setTitle("상품 등록 성공").setMessage("해당 상품등록을 완료하였습니다.").setUrlTitle("등록상품확인")
